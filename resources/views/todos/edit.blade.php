    ...
    <div class="m-auto w-[600px] p-10 bg-green-500">
        ...
        <form action="{{ route('todos.update', $todo->id) }}" method="post">
            ...
            <div class="mb-6">
                ...
                <input type="descripton" value="{{ $todo->description }}" id="descripton" name="description"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    required>
            </div>
            <div class="mb-6">
                ...
                <div class="flex items-center">
                    @if ($todo->completed === 1)
                        <input value="1" checked name="completed" id="checked-checkbox" type="checkbox" value=""
                    ...
                    @else
                        <input value="0" name="completed" id="checked-checkbox" type="checkbox"
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-green-600 dark:ring-offset-green-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    @endif
